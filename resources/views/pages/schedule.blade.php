            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                @if (auth()->user()->group_id === 1)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-add-tab" data-bs-toggle="pill" data-bs-target="#pills-add" type="button" role="tab" aria-controls="pills-add" aria-selected="false">Добавить расписание</button>
                    </li>
                @endif
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Расписание</button>
                </li>
                <li class="nav-item" role="presentation">
